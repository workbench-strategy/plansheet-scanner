...
class TestFeatureImportance:
    ...
    def test_calculate_feature_importance_success(
        self, adaptive_reviewer, mock_random_forest, sample_feature_names
    ):
        ...
        # Execute
        result = adaptive_reviewer.calculate_feature_importance(
            "random_forest", sample_feature_names
        )
    ...
    def test_calculate_feature_importance_invalid_model(
        self, adaptive_reviewer, sample_feature_names
    ):
        ...
        with pytest.raises(KeyError) as exc_info:
            adaptive_reviewer.calculate_feature_importance(
                "invalid_model", sample_feature_names
            )
    ...
    def test_calculate_feature_importance_mismatched_features(
        self, adaptive_reviewer, mock_random_forest
    ):
        ...
        with pytest.raises(ValueError) as exc_info:
            adaptive_reviewer.calculate_feature_importance(
                "random_forest", mismatched_features
            )

        assert "Feature names length (2) doesn't match model features (4)" in str(
            exc_info.value
        )

    def test_calculate_feature_importance_non_tree_model(
        self, adaptive_reviewer, mock_non_tree_model, sample_feature_names
    ):
        ...
        with pytest.raises(ValueError) as exc_info:
            adaptive_reviewer.calculate_feature_importance(
                "logistic_regression", sample_feature_names
            )

        assert "Model 'logistic_regression' is not a tree-based model" in str(
            exc_info.value
        )

    def test_calculate_feature_importance_gradient_boosting(
        self, adaptive_reviewer, mock_gradient_boosting, sample_feature_names
    ):
        ...
        # Execute
        result = adaptive_reviewer.calculate_feature_importance(
            "gradient_boosting", sample_feature_names
        )
    ...
    def test_get_feature_importance_json_success(
        self, adaptive_reviewer, mock_random_forest, sample_feature_names
    ):
        ...
        # Execute
        result_json = adaptive_reviewer.get_feature_importance_json(
            "random_forest", sample_feature_names
        )
    ...
    def test_get_feature_importance_json_invalid_model(
        self, adaptive_reviewer, sample_feature_names
    ):
        ...
        with pytest.raises(KeyError):
            adaptive_reviewer.get_feature_importance_json(
                "invalid_model", sample_feature_names
            )

    @patch("core.adaptive_reviewer.logging")
    def test_calculate_feature_importance_logging(
        self, mock_logging, adaptive_reviewer, mock_random_forest, sample_feature_names
    ):
    ...
    @pytest.mark.parametrize(
        "importance_values,expected_order",
        [
            (
                [0.1, 0.2, 0.3, 0.4],
                ["feature_4", "feature_3", "feature_2", "feature_1"],
            ),
            (
                [0.4, 0.3, 0.2, 0.1],
    ...
    def test_feature_importance_sorting_variations(
        self, adaptive_reviewer, importance_values, expected_order
    ):
